...
<head>
    ...
    <title>Grantho-Puri | @yield('siteTitle', 'Home')</title>
    <!-- Style Css Link -->
                  ...
                  <h4 class="text-center text-dark  fw-bold ">Tourist Mini Bus Seat Layout</h4>
                        <table class="w-100 seat_plan">
                          ...
                          <tr>
                              ...
                              <th  class="border w-25 text-center " >
                                      <button type="button" class="btn text-black fw-bold fullbutton" value="1">4</button>
                              </th>
                          ...
                          <tr>
                            <th scope="row"  class="border w-25 text-center ">
                              ...
                              <th   class="border text-center w-25 " >
                                      <button type="button" class="btn text-black fw-bold fullbutton" value="1">6</button>
                              </th>
                          </tr>
                          <tr>
                            <th scope="row" class="border text-center w-25 " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">7</button>
                                  </th>
                                <th  class="text-center w-25 ">
                                    <button type="button" class="btn btn-outline-secondary text-black fw-bold" value="1">
                                      25
                                  ...
                                  <th   class="border text-center w-25" >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">8</button>
                                  </th>
                                  <th   class="border text-center  w-25 " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">9</button>
                                  </th>
                          </tr>
                          <tr>
                            <th scope="row" class="border text-center w-25 " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">10</button>
                                  </th>
                                <th  class="text-center ">
                                  ...
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">11</button>
                                  </th>
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">12</button>
                                  </th>
                          </tr>
                          <tr>
                            <th scope="row" class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">13</button>
                                  </th>
                                <th  class="text-center ">
                                    <button type="button" class="btn btn-outline-secondary text-black fw-bold" value="1">
                                      27
                                  ...
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">14</button>
                                  </th>
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">15</button>
                                  </th>
                          </tr>
                          <tr>
                            <th scope="row" class="border text-center  " >
                                    <button type="button" class="btn  fw-bold fullbutton" value="1">16</button>
                                  </th>
                                <th  class="text-center">
                                    <button type="button" class="btn btn-outline-secondary text-black fw-bold" value="1">
                                      28
                                  ...
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">17</button>
                                  </th>
                                  <th   class="border text-center " >
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">18</button>
                                  </th>
                          </tr>
                              ...
                              <tr>
                                  <th scope="row" class="border text-center ">
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">19</button>
                                  </th>
                        
                          
                                  <th class="border text-center ">
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">20</button>
                                  </th>
                            
                              
                                  <th class="border text-center ">
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">21</button>
                                  </th>
                            
                              
                                  <th class="border text-center ">
                                    <button type="button" class="btn text-black fw-bold fullbutton" value="1">22</button>
                                  </th>
                                </tr>
...
function updateSeatStatus(button) {
    ...
    if (button.style.backgroundColor !== 'lightgreen') {
        $(button).parent().css('background','lightgreen')
        button.style.backgroundColor = 'lightgreen';
        bookedSeats++;
        totalAmount += seatPrice;
    } else {
        button.style.backgroundColor = '';
        $(button).parent().css('background','')
        bookedSeats--;
        totalAmount -= seatPrice;
    }
