                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="about_title_en" class="form-control" name="about_title_en" rows="2">{{ old('about_title_en')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="about_title_bn" class="form-control" name="about_title_bn" rows="2">{{ old('about_title_bn')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="about_description_en" class="form-control" name="about_description_en"  rows="3">{{ old('about_description_en')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="about_description_bn" class="form-control" name="about_description_bn"  rows="3">{{ old('about_description_bn')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="mission_title_en" class="form-control" name="mission_title_en"  rows="2">{{ old('mission_title_en')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="mission_title_bn" class="form-control" name="mission_title_bn"  rows="2">{{ old('mission_title_bn')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="mission_description_en" class="form-control" name="mission_description_en"  rows="3">{{ old('mission_description_en')}}</textarea>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="mission_description_bn" class="form-control" name="mission_description_bn"  rows="3">{{ old('mission_description_bn')}}</textarea>
