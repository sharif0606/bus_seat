                          ...
                          <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.settings.update',encryptor('encrypt',$settings->id))}}">
                              ...
                              @method('patch')
                                  ...
                                  <div class="row mb-3">
                                      ...
                                      <div class="col-sm-6 offset-1">
                                          <textarea name="address_en" class="form-control" cols="30" rows="2">{{ old('address_en',$settings->address_en)}}</textarea>
                                      </div>
                                  </div>
                                  <div class="row mb-3">
                                      <label for="contact" class="col-sm-2 offset-1 col-form-label"><b>{{__('Address BN')}}:</b></label>
                                      <div class="col-sm-6 offset-1">
                                          <textarea name="address_bn" class="form-control" cols="30" rows="2">{{ old('address_bn',$settings->address_bn)}}</textarea>
                                      </div>
                                  </div>
                                  <div class="row mb-3">
