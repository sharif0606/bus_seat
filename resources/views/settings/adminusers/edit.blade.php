                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="userName" class="form-control" value="{{ old('userName',$user->name_en)}}" name="userName">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name_bn" class="form-control" value="{{ old('name_bn',$user->name_bn)}}" name="name_bn">
                                        </div>
                                    </div>
